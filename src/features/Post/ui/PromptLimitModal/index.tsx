...
import css from "./PromptLimitModal.module.scss";
...
export const PromptLimitModal: React.FC<Props> = (props) => {
      ...
      <Modal active={active} onClose={onClose}>
         <div className={css.modal}>
            ...
            <p className={css.modal_text}>
               Your daily credits refresh at 00:00.
               <br />Please wait until then or <a href="/pricing">upgrade</a> your plan to increase your limits.
            </p>
