import type { SerializedUploadNode } from "../../types/nodeTypes";
import type { UploadDataImproved } from "../../types/uploadNode";
...
export const UploadJSXConverter: JSXConverters<SerializedUploadNode> = {
  upload: ({ node }) => {
    ...
    const uploadDoc = uploadNode.value as any;
    ...
    for (const size in uploadDoc.sizes) {
      const imageSize = uploadDoc.sizes[size] as any;
